...
import static org.melusky.util.StringValuedEnumReflect.*;
...
public class StringValuedEnumType <T extends Enum>
        implements org.hibernate.usertype.UserType, ParameterizedType {
	...
	*/
    ...
    throws HibernateException, SQLException {
        if (value == null) {
        	...
        	if (pgEnum){
                st.setObject( index, reflectGetValue(value), 1111 ); // 1111 = java.sql.Types "OTHER"
        	} else {
        		st.setString( index, reflectGetValue(value) );
        	}
        }
    }
    ...
    */
    ...
    public void nullSafeSet(PreparedStatement preparedStatement, Object value, int index, SessionImplementor sessionImplementor) throws HibernateException, SQLException {
        if (value == null) {
            ...
            if (pgEnum){
                preparedStatement.setObject( index, reflectGetValue(value), 1111 ); // 1111 = java.sql.Types "OTHER"
            } else {
                preparedStatement.setString( index, reflectGetValue(value) );
            }
        }
    }
